...
A simple, elegant, and lightning-fast multi-collection platform for poets. Stanza allows you to host multiple collections of work under a single, beautiful landing page, all without the need for databases.

## [👉 Download Latest Version](https://github.com/cozats/Stanza/archive/refs/heads/main.zip)

![alt text](https://github.com/cozats/Stanza/blob/main/screenshots/home.png)  
...
- **Modern UI Refinements:**
    ...
    - **Refined Toasts:** Solid, desaturated notification boxes with animations.
- **Unified Management:** A single login/session grants access to all collections and profiles.
- **Minimalist Design:** Focus on the text with beautiful typography (EB Garamond).
- **High Speed:** Built with clean PHP, no heavy frameworks or databases required.
- **Bilingual Support:** Full UI and content support for English and Greek.
- **Smart Content Loading:** Automatic translation pairing (e.g., `poem_en.md`).

## 🛠️ Requirements
- Any hosting provider with **PHP** support.
- No database (MySQL/PostgreSQL) required.
...
Μια απλή, κομψή και εξαιρετικά γρήγορη πλατφόρμα πολλαπλών συλλογών για ποιητές. Το Stanza σας επιτρέπει να φιλοξενείτε πολλές συλλογές έργων σε μια ενιαία αρχική σελίδα, χωρίς την ανάγκη για βάσεις δεδομένων.
